			...
			<div class="row align-items-center text-center">
				<div class="col-md-12">
					...
					<div class="card-body">
						...
						{{-- <h4 class="mb-3 f-w-400">Enter Your Email</h4> --}}
						{{-- <div class="input-group mb-3"> --}}
							{{-- <span class="input-group-text"><i class="feather icon-mail"></i></span> --}}
							<input type="hidden"   class="form-control" autofocus value="{{ $email }}" name="email" placeholder="User Name">
						{{-- </div> --}}
						<h4 class="mb-3 f-w-400">Enter New Password</h4>
                        ...
                        {{-- <a href="{{ url('reset/password') }}" class="btn btn-block  mt-2 mb-4 text-primary" style="float: left">
                        <small>reset password</small>
                        </a> --}}

                        <button type="submit"  class="btn btn-block btn-primary mt-2 mb-4">Submit</button>
