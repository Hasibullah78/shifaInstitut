                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('technology/subjects/fourth') }}">ټول مضامین</a>
                                <a href="{{ url('technology/subjects/fourth/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/fourth'.$subject->id) }}" method="POST">
                    @csrf
