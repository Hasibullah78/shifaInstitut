            ...
            <table class="table table-hover table-bordered"  dir="rtl">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><a href="{{ url('final/results'.$student->id) }}" class="btn btn-primary">View</a></td>
                        ...
                        {{-- <td style="text-align: center" >
                         ...
                         @php
                      $marks_s=ExamMark::all()->where('student_id','==',$student->id)->first();
                        ...
                        <td style="text-align: center">
                            @if($marks_s)
                            @php
                                $marks_ss=ExamMark::all()->where('student_id','==',$marks_s->student_id);
                            @endphp
                        ...
                        @endif
                           ...
                           @if(!$marks_s)
                           <a href="{{ url('add/mideterm/marks'.$student->id) }}" class="btn btn-primary">نمری اضافه کړی</a>
