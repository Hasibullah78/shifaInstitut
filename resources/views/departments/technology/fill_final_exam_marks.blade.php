                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            {{-- <div class="dropdown" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('technology/subjects') }}">ټول مضامین</a>
                                <a href="{{ url('technology/subjects/add') }}">اضافه کول</a>
                                </div>
  ...
  <table>
            ...
            <table class="table table-hover table-bordered"  dir="rtl">
                ...
                <tbody>
                    ...
                    <td style="text-align: center"> @foreach ($markss as $mark)
                ...
                <td style="text-align: center">
                    ...
                    <a href="{{ url('fill/final/marks',['student_id'=>$student->id,'subject_id'=>$subject->id]) }}" class="btn btn-primary">Fill_Marks</a></td>
                    @endif
