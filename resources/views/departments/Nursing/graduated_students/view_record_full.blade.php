                        ...
                        <nav>
                            ...
                            @endforeach
                                ...
                                <div class="dropdown-content notprint">
                                    <a href="{{ url('nursing/first_semester/record'.$student_id) }}">لومړی سمیستر</a>
                                    <a href=" {{ url('nursing/second_semester/record'.$student_id) }}">دوهم سمیستر</a>
                                    <a href="{{ url('nursing/third_semester/record'.$student_id) }}">دریم سمیستر</a>
                                    <a href="{{ url('nursing/fourth_semester/record'.$student_id) }}">څلورم سمیستر</a>
                                    <a href="{{ url('nursing/fiveth_semester/record'.$student_id) }}">پنځم سمیستر</a>
                                    <a href="{{ url('nursing/sixth_semester/record'.$student_id) }}">شپږم سمیستر</a>
                                </div>
                                </div> --}}
                            <a href="{{ url('student/nursing/view/record'.$id) }}"><img src="{{ asset('frontend/assets/icons/back_arrow_64px.png') }}" alt=""></a>
