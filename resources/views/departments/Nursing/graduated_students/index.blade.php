                    ...
                    <div class="card-header">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form action="{{ url('student/graduated/nursing/y_search') }}" method="post">
                                                    @csrf
                                            ...
                                            <div class="col-md-6">
                                                <form action="{{ url('student/graduated/nursing/n_search') }}" method="post">
                                                    @csrf
                                                <div class="form-group">
                        ...
                        <tbody>
                            ...
                            <td style="text-align: center" id="center">
                             ...
                             <td style="text-align: center" id="center">
                                ...
                                <td style="text-align: center">
                                    <a href="{{ url('student/nursing/view/record'.$student->id) }}" class="btn btn-primary notprint" style="text-align: center">View-Record</a>
                                </td>
                                <td style="text-align: center">
