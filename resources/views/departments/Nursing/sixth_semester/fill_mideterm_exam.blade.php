                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('nursing/subjects/sixth') }}">ټول مضامین</a>
                                <a href="{{ url('nursing/subjects/sixth/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/nursing/sixth'.$subject->id) }}" method="POST">
                    @csrf
