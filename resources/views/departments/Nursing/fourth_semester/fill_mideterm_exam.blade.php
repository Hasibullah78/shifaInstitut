                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('nursing/subjects/fourth') }}">ټول مضامین</a>
                                <a href="{{ url('nursing/subjects/fourth/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/nursing/fourth'.$subject->id) }}" method="POST">
                    @csrf
