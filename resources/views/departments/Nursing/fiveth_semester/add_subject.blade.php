        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('add.subject.nursing.fiveth') }}" method="post">
                            @csrf
                           ...
                           @enderror
                            ...
                            <div class="form-group">
                             ...
                             @enderror
                              ...
                              <div class="form-group" >
                                <input type="text" hidden  name="semester" value="fiveth" class="form-control" id="exampleFormControlInput1" placeholder="">
                             @error('semester')
                                 <span class=" text-danger">{{ $message }}</span>
                             @enderror
                              </div>
