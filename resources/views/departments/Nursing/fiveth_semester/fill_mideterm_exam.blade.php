                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('nursing/subjects/fiveth') }}">ټول مضامین</a>
                                <a href="{{ url('nursing/subjects/fiveth/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/nursing/fiveth'.$subject->id) }}" method="POST">
                    @csrf
