                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <a href="{{ url('select/subject/final/nursing/third'.$subject->id) }}">{{ $subject->name }}</a>
            ...
            <table class="table table-hover table-bordered"  dir="rtl">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><a href="{{ url('final/results/nursing/third'.$student->id) }}" class="btn btn-primary">View</a></td>
