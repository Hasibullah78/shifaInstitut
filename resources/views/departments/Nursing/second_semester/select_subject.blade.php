                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <a href="{{ url('nursing/second/mideterm_exam') }}">منځنی ازموینه</a>
                            <a href="{{ url('nursing/second/final_exam') }}">  وروستی ازموینه </a>
                            </div>
                    ...
                    {{-- <div class="col-md-3" >
                        <form action="{{ url('student/second/semester/search') }}" method="post">
                            @csrf
                ...
                <thead>
                    ...
                    <tr>
                        <div class="row">
                            ...
                            @endif
                            <a href="{{ url('nursing/second/mideterm_exam') }}" class="btn btn-primary">Back to Subjects</a>
                        </div>
                      ...
                      $marks_s=ExamMark::all()->where('student_id','==',$student->id)->where('subject_id','==',$subject->id)->first();
                        ...
                        <td style="text-align: center">
                           ...
                           @if(!$marks_s)
                                ...
                                <a href="{{ route('AddMideterm.nursing.second',['student_id'=>$student->id,'subject_id'=>$subject->id]) }}" class="btn btn-primary">نمری اضافه کړی</a>
