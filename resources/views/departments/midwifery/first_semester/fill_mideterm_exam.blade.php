                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('midwifery/subjects/first') }}">ټول مضامین</a>
                                <a href="{{ url('midwifery/subjects/first/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/midwifery/first'.$subject->id) }}" method="POST">
                    @csrf
