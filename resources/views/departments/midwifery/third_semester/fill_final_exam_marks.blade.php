        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-3" >
                        <form action="{{ url('student/third/semester/search') }}" method="post">
                            @csrf
  ...
  <table>
            ...
            <table class="table table-hover table-bordered"  dir="rtl">
                ...
                <td style="text-align: center">
                    ...
                    <a href="{{ url('fill/final/marks/midwifery/third',['student_id'=>$student->id,'subject_id'=>$subject->id]) }}" class="btn btn-primary">Fill_Marks</a></td>
                    @endif
