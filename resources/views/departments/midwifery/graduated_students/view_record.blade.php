                        ...
                        <nav>
                            ...
                            @endforeach
                                ...
                                <div class="dropdown-content notprint">
                                    <a href="{{ url('midwifery/first_semester/record'.$student_id) }}">لومړی سمیستر</a>
                                    <a href=" {{ url('midwifery/second_semester/record'.$student_id) }}">دوهم سمیستر</a>
                                    <a href="{{ url('midwifery/third_semester/record'.$student_id) }}">دریم سمیستر</a>
                                    <a href="{{ url('midwifery/fourth_semester/record'.$student_id) }}">څلورم سمیستر</a>
