                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <a href="{{ url('select/subject/final/prothess/first'.$subject->id) }}">{{ $subject->name }}</a>
...
<tr>
    <td colspan="12" style="text-align: center">
        ...
        @endif
        @if($semester=='fourth')
        <a href="{{ url('prothess/pass/fiveth'.$student_id) }}" class=" btn btn-primary">Graduate Student</a>
        @endif
        @endif
    @if($result<50)
