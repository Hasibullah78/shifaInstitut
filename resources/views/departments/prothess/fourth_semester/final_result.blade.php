            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <nav>
                                <li id="list" class="notprint"><a  href="{{ url('prothess/teachers') }}" class="btn btn-primary notprint">استادان</a></li>
                                ...
                                <div class="dropdown-content notprint">
                                    <a href="{{ url('prothess/first_semester') }}">لومړی سمیستر</a>
                                    <a href=" {{ url('prothess/second_semester') }}">دوهم سمیستر</a>
                                    <a href="{{ url('prothess/third_semester') }}">دریم سمیستر</a>
                                    <a href="{{ url('prothess/fourth_semester') }}">څلورم سمیستر</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <a href="{{ url('select/subject/final/prothess/fourth'.$subject->id) }}">{{ $subject->name }}</a>
...
<tr>
    <td colspan="12" style="text-align: center">
        @if($result>=50)
        @if($semester=='first')
        <a href="{{ url('prothess/pass/second'.$student_id) }}" class="btn btn-primary">Pass to second</a>
        @endif
        @if($semester=='second')
        <a href="{{ url('prothess/pass/third'.$student_id) }}" class="btn btn-primary">Pass to Third</a>
        @endif
        @if($semester=='third')
        <a href="{{ url('prothess/pass/fourth'.$student_id) }}" class="btn btn-primary">Pass to Fourth</a>
        @endif
        @if($semester=='fourth')
        <a href="{{ url('prothess/pass/graduate'.$student_id) }}" class=" btn btn-primary">Graduate Student</a>
        @endif
        @endif
    @if($result<50)
