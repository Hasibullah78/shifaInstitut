                        ...
                        <nav>
                            ...
                            @endforeach
                                ...
                                <div class="dropdown-content notprint">
                                    <a href="{{ url('prothess/first_semester/record'.$student_id) }}">لومړی سمیستر</a>
                                    <a href=" {{ url('prothess/second_semester/record'.$student_id) }}">دوهم سمیستر</a>
                                    <a href="{{ url('prothess/third_semester/record'.$student_id) }}">دریم سمیستر</a>
                                    <a href="{{ url('prothess/fourth_semester/record'.$student_id) }}">څلورم سمیستر</a>
