                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <a href="{{ url('select/subject/final/pharmicy/second'.$subject->id) }}">{{ $subject->name }}</a>
...
<tr>
    <td colspan="12" style="text-align: center">
        @if($result>=50)
        @if($semester=='first')
        <a href="{{ url('pharmicy/pass/second'.$student_id) }}" class="btn btn-primary">Pass to second</a>
        @endif
        @if($semester=='second')
        <a href="{{ url('pharmicy/pass/third'.$student_id) }}" class="btn btn-primary">Pass to Third</a>
        @endif
        @if($semester=='third')
        <a href="{{ url('pharmicy/pass/fourth'.$student_id) }}" class="btn btn-primary">Pass to Fourth</a>
        @endif
        @if($semester=='fourth')
        <a href="{{ url('pharmicy/pass/graduate'.$student_id) }}" class=" btn btn-primary">Graduate Student</a>
        @endif
        @endif
    @if($result<50)
