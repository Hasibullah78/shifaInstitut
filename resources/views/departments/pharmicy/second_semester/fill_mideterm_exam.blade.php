                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('pharmicy/subjects/second') }}">ټول مضامین</a>
                                <a href="{{ url('pharmicy/subjects/second/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/pharmicy/second'.$subject->id) }}" method="POST">
                    @csrf
