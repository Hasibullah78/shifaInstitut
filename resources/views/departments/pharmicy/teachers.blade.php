    ...
    <div class="pcoded-content">
        <div class="row notprint">
            <div class="col-md-12 notprint">
                <div class="card" >
                    <div class="card-header">
                        <nav class="notprint">
                                <li id="list"><a href="{{ url('pharmicy/teachers') }}" class="btn btn-primary">استادان</a></li>
               ...
               <form action="{{ url('student/p_search') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-9">
            ...
            <table class="table table-hover table-bordered"  dir="rtl">
                <thead>
                    <tr><th colspan="9" style="text-align:center" > د فارمیسی څانګی استادانو لیست</th></tr>
