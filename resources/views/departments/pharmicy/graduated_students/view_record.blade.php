                        ...
                        <nav>
                            ...
                            @endforeach
                                ...
                                <div class="dropdown-content notprint">
                                    <a href="{{ url('pharmicy/first_semester/record'.$student_id) }}">لومړی سمیستر</a>
                                    <a href=" {{ url('pharmicy/second_semester/record'.$student_id) }}">دوهم سمیستر</a>
                                    <a href="{{ url('pharmicy/third_semester/record'.$student_id) }}">دریم سمیستر</a>
                                    <a href="{{ url('pharmicy/fourth_semester/record'.$student_id) }}">څلورم سمیستر</a>
...
@endphp
            ...
            <h3 class=" text-primary mb-5 mt-5" style="text-align: center">لومړي سیمیستر پایلی</h3>
...
@php
    ...
    $student_id='';
@endphp
                    @foreach ($first_semester as $student)
                    <tr>
                        <td style="text-align: center">{{ $student->std_name}}</td>
                        <td style="text-align: center">{{ $student->std_f_name}}</td>
            ...
            {{-- <h3 class=" text-primary" style="text-align: center">لومړي سیمیستر پایلی</h3> --}}
            <table class="table border-1 table-sm table-hover table-stripped d-print-table-row" style="font-size:12px;line-height: 1rem;s" dir="rtl">
                <thead class="bg-success text-bold">
                    {{-- <a href="{{ route('show.dep') }}">All</a> --}}
                    <tr>
                ...
                <tbody>
                    ...
                    @foreach ($first_semester as $mark)
...
<tr>
    ...
    @endif
            ...
            <h3 class=" text-primary mb-5 mt-5" style="text-align: center">دوهم سیمیستر پایلی</h3>
            <table class="table border-1 table-sm table-hover table-stripped d-print-table-row" style="font-size:12px;line-height: 1rem;s" dir="rtl">
                <thead class="bg-success text-bold">
                    {{-- <a href="{{ route('show.dep') }}">All</a> --}}
                    <tr>
...
@php
    ...
    $student_id='';
@endphp
                    @foreach ($second_semester as $student)
                    <tr>
                        <td style="text-align: center">{{ $student->std_name}}</td>
                        <td style="text-align: center">{{ $student->std_f_name}}</td>
            ...
            <table class="table border-1 table-sm table-hover table-stripped d-print-table-row" style="font-size:12px;line-height: 1rem;s" dir="rtl">
                ...
                <tbody>
                    ...
                    @foreach ($second_semester as $mark)
...
<tr>
    ...
    @endif
            ...
            <h3 class=" text-primary mb-5 mt-5" style="text-align: center">دریم سیمیستر پایلی</h3>
            <table class="table border-1 table-sm table-hover table-stripped d-print-table-row" style="font-size:12px;line-height: 1rem;s" dir="rtl">
                <thead class="bg-success text-bold">
                    {{-- <a href="{{ route('show.dep') }}">All</a> --}}
                    <tr>
...
@php
    ...
    $student_id='';
@endphp
                    @foreach ($third_semester as $student)
                    <tr>
                        <td style="text-align: center">{{ $student->std_name}}</td>
                        <td style="text-align: center">{{ $student->std_f_name}}</td>
            ...
            <table class="table border-1 table-sm table-hover table-stripped d-print-table-row" style="font-size:12px;line-height: 1rem;s" dir="rtl">
                ...
                <tbody>
                    ...
                    @foreach ($third_semester as $mark)
...
<tr>
    ...
    @endif
            ...
            <h3 class=" text-primary mb-5 mt-5" style="text-align: center">څلورم سیمیستر پایلی</h3>
            <table class="table border-1 table-sm table-hover table-stripped d-print-table-row" style="font-size:12px;line-height: 1rem;s" dir="rtl">
                <thead class="bg-success text-bold">
                    {{-- <a href="{{ route('show.dep') }}">All</a> --}}
                    <tr>
...
@php
    ...
    $student_id='';
@endphp
                    @foreach ($fourth_semester as $student)
                    <tr>
                        <td style="text-align: center">{{ $student->std_name}}</td>
                        <td style="text-align: center">{{ $student->std_f_name}}</td>
            ...
            <table class="table border-1 table-sm table-hover table-stripped d-print-table-row" style="font-size:12px;line-height: 1rem;s" dir="rtl">
                ...
                <tbody>
                    ...
                    @foreach ($fourth_semester as $mark)
...
<tr>
    ...
    <button class="notprint btn btn-primary mt-3"  style="float: right" onclick="print();"> Print</button>
