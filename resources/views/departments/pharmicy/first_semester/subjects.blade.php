                    ...
                    <div class="col-md-4">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('pharmicy/subjects/first') }}">ټول مضامین</a>
                                <a href="{{ url('pharmicy/subjects/first/add') }}">اضافه کول</a>
                                </div>
                    ...
                    <td style="text-align: center" id="center">
                     ...
                     <td style="text-align: center" id="center">
                        ...
                        <td style="text-align: center">
                            <a href="{{ url('pharmicy/fisrt_semester/edit/subject'.$subject->id) }}" class="btn btn-danger">Edit</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
