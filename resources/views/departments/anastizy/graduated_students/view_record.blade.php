                        ...
                        <nav>
                            ...
                            @endforeach
                                ...
                                <div class="dropdown-content notprint">
                                    <a href="{{ url('anastizy/first_semester/record'.$student_id) }}">لومړی سمیستر</a>
                                    <a href=" {{ url('anastizy/second_semester/record'.$student_id) }}">دوهم سمیستر</a>
                                    <a href="{{ url('anastizy/third_semester/record'.$student_id) }}">دریم سمیستر</a>
                                    <a href="{{ url('anastizy/fourth_semester/record'.$student_id) }}">څلورم سمیستر</a>
