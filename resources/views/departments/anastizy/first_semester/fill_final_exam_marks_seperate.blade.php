                ...
                <div class="row">
                    ...
                    <div class="col-md-12 notprint">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            <button class="dropbtn btn btn-primary mt-3 notprint" ><h5 style="color: white">ازموینو کټګوری</h5> </button>
                            <div class="dropdown-content">
                                <a href="{{ url('anastizy/first/mideterm_exam') }}">منځنی ازموینه</a>
                                <a href="{{ url('anastizy/first/final_exam') }}">  وروستی ازموینه </a>
                            </div>
...
<table class="table table-hover table-bordered" dir="rtl">
    ...
    <tbody>
        <tr>
            ...
            <form action="{{ url('save/student/final/marks/anastizy/first',['student_id'=>$student->id,'subject_id'=>$subject->id]) }}" method="POST">
                @csrf
