            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="row">
                        ...
                        {{-- <div class="col-md-2 mt-4 notprint">
                    ...
                    <div class="col-md-4 notprint">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content notprint" style="text-align: center">
                                    @foreach ($subjects as $subject)
                                <a href="{{ url('select/subject/final/anastizy/first'.$subject->id) }}">{{ $subject->name }}</a>
            ...
            <table class="table table-hover table-bordered"  dir="rtl">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><a href="{{ url('final/results/anastizy/first'.$student->id) }}" class="btn btn-primary">View</a></td>
