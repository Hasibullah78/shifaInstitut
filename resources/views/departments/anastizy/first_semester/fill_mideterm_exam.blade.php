                    ...
                    <div class="col-md-4 notprint">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <a href="{{ url('anastizy/subjects/first') }}">ټول مضامین</a>
                                <a href="{{ url('anastizy/subjects/first/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/anastizy/first'.$subject->id) }}" method="POST">
                    @csrf
