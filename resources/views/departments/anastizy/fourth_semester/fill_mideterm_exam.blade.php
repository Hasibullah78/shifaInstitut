                    ...
                    <div class="col-md-4 notprint">
                        ...
                        <div class="dropdown mb-3 notprint" id="list">
                            ...
                            <div class="dropdown mb-3 notprint" id="list">
                                ...
                                <div class="dropdown-content">
                                <a href="{{ url('anastizy/subjects/fourth') }}">ټول مضامین</a>
                                <a href="{{ url('anastizy/subjects/fourth/add') }}">اضافه کول</a>
                                </div>
...
<div class="row">
    ...
    @endif
                ...
                <tbody>
                 <form action="{{ url('save/mideterm/marks/anastizy/fourth'.$subject->id) }}" method="POST">
                    @csrf
